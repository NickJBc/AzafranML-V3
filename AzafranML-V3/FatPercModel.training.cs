...
namespace AzafranML_V3
{
    public partial class FatPercModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:66,seriesLength:2930,trainSize:2211,horizon:10,outputColumnName:@"Fat Percentage",inputColumnName:@"Fat Percentage",confidenceLowerBoundColumn:@"Fat Percentage_LB",confidenceUpperBoundColumn:@"Fat Percentage_UB");
